...
const SubNav: React.FC<SubNavProps> = ({ selectedCategory, onCategoryClick }) => {
  ...
  return (
    <div className="sticky top-16 z-40 bg-white/90 backdrop-blur-md border-b border-retiro-sesame">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-sm transition-colors duration-200 border ${
                  selectedCategory === 'all'
                    ? 'bg-retiro-red text-white border-retiro-red'
                    : 'bg-white text-gray-700 border-gray-300 hover:border-retiro-red'
                }`}
              >
                All
              </button>
